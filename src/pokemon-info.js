...
function setupEvolution(chain, no) {
    ...
    chainImages[no].setAttribute('onClick', 'src: ' + 'openInfo(' + filterIdFromSpeciesURL(chain.species.url) + ')');
    ...
    chainImages[no + 1].setAttribute('onClick', 'src: ' + 'openInfo(' + filterIdFromSpeciesURL(chain.evolves_to[0].species.url) + ')');
